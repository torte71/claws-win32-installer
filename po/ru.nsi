...
LangString T_InstallOptLinks ${LANG_RUSSIAN} "Ярлыки Claws Mail"
LangString T_InstOptLabelA ${LANG_RUSSIAN} "Где создавать ярлыки Claws Mail:"
...
LangString T_FoundExistingVersion ${LANG_RUSSIAN} "Версия $R1 уже установлена.\nПерезаписать ее версией ${VERSION}?"
LangString T_FoundExistingOldVersion ${LANG_RUSSIAN} "Gpg4Win уже установлена на этом компьютере. Дальнейшая установка перезапишет эту версию новой.\n\nПродолжить установку Gpg4Win?"
LangString T_FoundExistingVersionB ${LANG_RUSSIAN} "Gpg4Win уже установлена на этом компьютере. Дальнейшая установка перезапишет эту версию новой.\n\nПродолжить установку Gpg4Win?"
LangString T_WelcomePageTitle ${LANG_RUSSIAN} "Добро пожаловать в программу установки Claws Mail!"
...
LangString T_AboutVersion ${LANG_RUSSIAN} "Версия Claws Mail ${VERSION}"
